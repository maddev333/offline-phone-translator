...
async function loadModel() {
  ...
  state.loading = true; setStatus("Loading ASR", "warn"); setProgress("Downloading about 750 MB on first use. Keep this page open."); updateControls(); ensureWorker().postMessage({ type: "init" });
}
function flushAudio() {
